...
class CreatAlertDialog {
          ...
          return AlertDialog(
            ...
            content: Column(
              ...
              children: [
                ...
                Icon(icon,size: 40,color: mainColor2,),
                SizedBox(height: getSize(context: context).height*0.03,),
                Text(
                  "01006272761",
                ...
                Row(
                  ...
                  children: [
                  MaterialButton(onPressed: (){}, child: Text(languageProvider!.getTexts("copy"), style: MainTitle.display5(context),),),
                  MaterialButton(onPressed: (){}, child: Text(title, style: MainTitle.display5(context),),),
                  ],
                ),
                SizedBox(
  ...
  creatTree({ required BuildContext? context, void Function()? onPressDelete}) {
    showDialog(
        context: context!,
        builder: (BuildContext context) {
          languageProvider =
          ...
          return AlertDialog(
            ...
            elevation: 5,
            content: Container(
              height: getSize(context: context).height*0.24,
              child: Column(
                children: [
                  // Row(
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: Text(languageProvider!.getTexts("inductionTree"),style: WhiteTitle.display5(context),),
                    ),
                  ),
                  InkWell(
                    onTap: (){},
                    child: Container(
                      ...
                      child: Text(languageProvider!.getTexts("symbolsTree"),style: WhiteTitle.display5(context),),
                    ),
                  ),
                  InkWell(
                    onTap: (){},
                    child: Container(
                      ...
                      child: Text(languageProvider!.getTexts("printedTree"),style: WhiteTitle.display5(context),),
                    ),
                  ),
